...
const button = tv({
  ...
  variants: {
    variant: {
      ...
      icon: "border-0 p-1 flex items-center justify-center text-brand-colour-5 hover:bg-icon-hover hover:text-default-bg",
      iconNoInteraction:
        "border-0 p-1 flex items-center justify-center focus-visible:ring-offset-1",
    },
    isDisabled: {
      true: "",
    },
