...
const styles = tv({
  ...
  variants: {
    ...
    isExiting: {
      true: "animate-out fade-out duration-200 ease-out placement-bottom:slide-out-to-top-1 placement-top:slide-out-to-bottom-1 placement-left:slide-out-to-right-1 placement-right:slide-out-to-left-1 ease-in duration-150",
    },
  },
});
