...
public class BillingAddress {
    ...
    @MinIfPresent(min = 5, message = "{billing.address-line-2.min-if-present}")
    @Size(max = 100, message = "{billing.address-line-2.size}")
    ...
    @MinIfPresent(min = 3, message = "{billing.county.min-if-present}")
